...
const programsUnit5 = [
  ...
  {
    id: 6,
    title: "Subtraction of Two 8-bit Numbers",
    code: "LDA 3000H\nMOV B,A\nLDA 3001H\nSUB B\nSTA 4000H\nHLT",
  },
  {
    id: 7,
  ...
  {
    id: 12,
    title: "Positive and Negative Number Separation",
    code: "LXI H,3000H\nMOV C,M\nINX H\nLOOP: MOV A,M\nRAL\nJC NEGATIVE\nSTA 4000H\nJMP NEXT\nNEGATIVE: STA 5000H\nNEXT: INX H\nDCR C\nJNZ LOOP\nHLT",
  },
  {
    id: 13,
    title: "Even and Odd Number Separation",
    code: "LXI H,3000H\nLXI D,4000H\nLXI B,5000H\nMVI C,0AH\nLOOP: MOV A,M\nANI 01H\nJNZ ODD\nMOV A,M\nSTAX D\nINX D\nJMP NEXT\nODD: MOV A,M\nSTAX B\nINX B\nNEXT: INX H\nDCR C\nJNZ LOOP\nHLT",
  },
  {
    id: 14,
    title: "Count Number of 1's in 8-bit Data",
    code: "MVI B,00H\nMVI C,08H\nLOOP: RAR\nJNC SKIP\nINR B\nSKIP: DCR C\nJNZ LOOP\nHLT",
  },
  {
    id: 15,
    title: "Exchange Two 8-bit Numbers",
    code: "LDA 3000H\nMOV B,A\nLDA 3001H\nSTA 3000H\nMOV A,B\nSTA 3001H\nHLT",
  },
  {
    id: 16,
  ...
  {
    id: 19,
    title: "Factorial of 8-bit Number",
    code: "LXI H,3000H\nMOV B,M\nMVI A,01H\nLOOP: MOV C,B\nCALL MULT\nDCR B\nJNZ LOOP\nSTA 4000H\nHLT\nMULT: MOV D,A\nMVI A,00H\nM1: ADD D\nDCR C\nJNZ M1\nRET",
  },
  {
    id: 20,
  ...
  // --- Unique entries from the 35-program array ---
  {
    id: 21,
